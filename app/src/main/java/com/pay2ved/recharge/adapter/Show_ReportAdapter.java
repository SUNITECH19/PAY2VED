...
public class Show_ReportAdapter extends RecyclerView.Adapter<Show_ReportAdapter.ViewHolder> {

    List<ShowFormGetSet> mItems;
    private ArrayList<ShowFormGetSet> arraylist;
    Context context;

    public Show_ReportAdapter(Context context, List<ShowFormGetSet> products) {
        super();
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View v = LayoutInflater.from(viewGroup.getContext())
                .inflate(R.layout.transaction_report_adapter, viewGroup, false);
    ...
    public void onBindViewHolder(ViewHolder viewHolder, int i) {
        ...
        viewHolder.txt_user.setText((nature.getUser()));
    ...
    class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        TextView txt_name, txt_user, txt_remark, txt_ref_no, txt_date, txt_amount, txt_type;
