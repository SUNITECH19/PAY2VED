...
import com.pay2ved.recharge.adapter.commission_ReportAdapter;
...
public class Commission_ReportActivity extends AppCompatActivity {
    ...
    commission_ReportAdapter mAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        img_filter.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(Commission_ReportActivity.this, Filter_transActivity.class);
        ...
        rlt_home.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Commission_ReportActivity.this, GprsHomeActivity.class);
                startActivity(intent);
                finish();
            }
        });
        ...
        rlt_my_account.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(Commission_ReportActivity.this, My_AccountActivity.class);
                startActivity(intent);
                finish();
            }
        });
        ...
        rlt_reports.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(Commission_ReportActivity.this, ReportsActivity.class);
                startActivity(intent);
                finish();
            }
        });
        ...
        LinearLayoutManager layoutManager = new LinearLayoutManager(Commission_ReportActivity.this);
    ...
    public void signUpClick() {
        cd = new ConnectionDetector(Commission_ReportActivity.this);
        if (!cd.isConnectingToInternet()) {

            Toast.makeText(Commission_ReportActivity.this, "noNetworkConnection", Toast.LENGTH_LONG).show();
        } else {
    ...
    private class GetContacts_commodity extends AsyncTask<String, Void, String> {
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(Commission_ReportActivity.this);
            ...
            try {
                ...
                if (js.has("data")) {
                    ...
                    for (int i = 0; i < contactsstate.length(); i++) {
                        ...
                        String a3 = c.getString("account");
                        String a4 = c.getString("amount");
                        String a5 = c.getString("commission");
                        String a6 = c.getString("date");
        ...
        protected void onPostExecute(String result) {
            ...
            mAdapter = new commission_ReportAdapter(Commission_ReportActivity.this, products);
