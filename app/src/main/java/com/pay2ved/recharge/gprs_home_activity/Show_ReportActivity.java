...
import com.pay2ved.recharge.adapter.Show_ReportAdapter;
...
public class Show_ReportActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        img_filter.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(Show_ReportActivity.this, Filter_transActivity.class);
        ...
        rlt_home.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Show_ReportActivity.this, GprsHomeActivity.class);
                startActivity(intent);
                finish();
            }
        });
        ...
        rlt_my_account.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(Show_ReportActivity.this, My_AccountActivity.class);
                startActivity(intent);
                finish();
            }
        });
        ...
        rlt_reports.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(Show_ReportActivity.this, ReportsActivity.class);
                startActivity(intent);
                finish();
            }
        });
        ...
        LinearLayoutManager layoutManager = new LinearLayoutManager(Show_ReportActivity.this);
    ...
    public void signUpClick() {
        cd = new ConnectionDetector(Show_ReportActivity.this);
        if (!cd.isConnectingToInternet()) {

            Toast.makeText(Show_ReportActivity.this, "noNetworkConnection", Toast.LENGTH_LONG).show();
        } else {
    ...
    private class GetContacts_commodity extends AsyncTask<String, Void, String> {
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(Show_ReportActivity.this);
        ...
        protected void onPostExecute(String result) {
            ...
            mAdapter = new Show_ReportAdapter(Show_ReportActivity.this, products);
