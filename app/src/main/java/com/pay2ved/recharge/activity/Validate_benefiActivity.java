...
public class Validate_benefiActivity extends AppCompatActivity {
    private ProgressDialog pDialog;
    EditText edt_name, edt_id, edt_account, edt_ifsc, edt_type, edt_aadhaar, edt_pan;
    Button btn_confirm, btn_cancel;
    ImageView img_back;
    String s_ben_id = "", s_name = "", s_account = "", s_ifsc = "", s_type = "", s_tran_type = "", s_aadhaar = "", s_pan = "";
    String s_Username = "", s_Password = "", s_mobile = "", s_Name = "", s_ID = "", s_Account = "",
            s_Type = "", s_Ifsc = "", s_Money_Valid = "";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.validate_dmt);
        ...
        s_Money_Valid = AppsContants.sharedpreferences.getString(AppsContants.Money_Valid, "");
        ...
        img_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Validate_benefiActivity.this, BeneficiaryActivity.class);
        ...
        dmt_text.setText(s_Money_Valid);
        ...
        group_type.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                ...
                if (selectedId == -1) {
                    Toast.makeText(Validate_benefiActivity.this, "Nothing selected", Toast.LENGTH_SHORT).show();
                } else {
        ...
        btn_confirm.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (s_ben_id.equals("")) {
                    isError = true;
                    edt_id.requestFocus();
                    Toast.makeText(Validate_benefiActivity.this, "Please Enter ID", Toast.LENGTH_LONG).show();

                } else if (s_name.equals("")) {
                    isError = true;
                    edt_name.requestFocus();
                    Toast.makeText(Validate_benefiActivity.this, "Please Enter Name", Toast.LENGTH_LONG).show();

                } else if (s_account.equals("")) {
                    isError = true;
                    edt_account.requestFocus();
                    Toast.makeText(Validate_benefiActivity.this, "Please Enter Account Number", Toast.LENGTH_LONG).show();

                } else if (s_type.equals("")) {
                    isError = true;
                    edt_type.requestFocus();
                    Toast.makeText(Validate_benefiActivity.this, "Please Enter Account Type", Toast.LENGTH_LONG).show();

                } else if (s_ifsc.equals("")) {
                    isError = true;
                    edt_ifsc.requestFocus();
                    Toast.makeText(Validate_benefiActivity.this, "Please Enter IFSC Code", Toast.LENGTH_LONG).show();

                } else if (s_tran_type.equals("")) {
                    isError = true;
                    Toast.makeText(Validate_benefiActivity.this, "Please Select Transaction Type", Toast.LENGTH_LONG).show();

                } else {
                    if (!isError) {
                        if (NetConnection.isConnected(Validate_benefiActivity.this)) {

                            AlertDialog.Builder builder = new AlertDialog.Builder(Validate_benefiActivity.this);
                            builder.setTitle("Are you sure?");
                            builder.setMessage("Do you want to validate beneficiary account!");
                            builder.setCancelable(false);
                            builder.setPositiveButton("Yes, Confirm!", new DialogInterface.OnClickListener() {
                                @Override
                                public void onClick(DialogInterface dialog, int which) {
                                    BenValidate task = new BenValidate();
                                    task.execute();
                                }
                            });
                            ...
                            Toast.makeText(Validate_benefiActivity.this, "No Internet Connection", Toast.LENGTH_SHORT).show();
                        }
    ...
    //========================================start_http==========================================/
    public class BenValidate extends AsyncTask<String, Void, String> {

        String Errormessage, object_res;
        boolean IsError = false;
        String msg = "";
        String RSP_CODE = "", SEND_MOB = "", BEN_NAME = "", BEN_BANK_NAME = "", BEN_BANK_ACCOUNT = "", BEN_IFSC = "", IMPS_REF_NO = "", API_TRANS_ID = "", API_STATUS = "";
        JSONObject jsonObject;

        @Override
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(Validate_benefiActivity.this);
        ...
        protected String doInBackground(String... arg0) {
            ...
            try {
                ...
                nameValuePair.add(new BasicNameValuePair("request", "beneficiaryValidate"));
                ...
                if (jsonObject.length() == 2) {
                    ...
                    BEN_BANK_ACCOUNT = jsonObject.getString("BEN_BANK_ACCOUNT");
                    BEN_IFSC = jsonObject.getString("BEN_IFSC");
        ...
        protected void onPostExecute(String result1) {
            ...
            if (!IsError) {
                ...
                Toast.makeText(Validate_benefiActivity.this, "" + Errormessage, Toast.LENGTH_SHORT).show();
            }
        }
